...
from .exceptions import JsonStatException, JsonStatMalformedJson
from .utility import lst2html
...
class JsonStatDataSet:
    ...
    def data(self, *args, **kargs):
        ...
        elif isinstance(self.__status, dict) and int(idx.real) not in self.__status:
            status = None
        else:
